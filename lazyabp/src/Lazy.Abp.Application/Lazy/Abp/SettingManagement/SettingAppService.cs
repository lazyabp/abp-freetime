    ...
    public class SettingAppService : ApplicationService, ISettingAppService
    {
        ...
        protected virtual async Task<ListResultDto<SettingGroupDto>> GetAllForProviderAsync(string providerName, string providerKey)
        {
            ...
            userSetting.AddDetail(
                ...
                ValueType.Boolean);
            userSetting.AddDetail(
                SettingDefinitionManager.Get(Lazy.Abp.Identity.Settings.IdentitySettingNames.User.SmsNewUserRegister),
                StringLocalizerFactory,
                await SettingManager.GetOrNullAsync(Lazy.Abp.Identity.Settings.IdentitySettingNames.User.SmsNewUserRegister, providerName, providerKey),
                ValueType.String);
            userSetting.AddDetail(
                SettingDefinitionManager.Get(Lazy.Abp.Identity.Settings.IdentitySettingNames.User.SmsResetPassword),
                StringLocalizerFactory,
                await SettingManager.GetOrNullAsync(Lazy.Abp.Identity.Settings.IdentitySettingNames.User.SmsResetPassword, providerName, providerKey),
                ValueType.String);
            userSetting.AddDetail(
                SettingDefinitionManager.Get(Lazy.Abp.Identity.Settings.IdentitySettingNames.User.SmsUserSignin),
                StringLocalizerFactory,
                await SettingManager.GetOrNullAsync(Lazy.Abp.Identity.Settings.IdentitySettingNames.User.SmsUserSignin, providerName, providerKey),
                ValueType.String);
            userSetting.AddDetail(
                SettingDefinitionManager.Get(Lazy.Abp.Identity.Settings.IdentitySettingNames.User.SmsPhoneNumberConfirmed),
                StringLocalizerFactory,
                await SettingManager.GetOrNullAsync(Lazy.Abp.Identity.Settings.IdentitySettingNames.User.SmsPhoneNumberConfirmed, providerName, providerKey),
                ValueType.String);
            userSetting.AddDetail(
                SettingDefinitionManager.Get(Lazy.Abp.Identity.Settings.IdentitySettingNames.User.SmsRepetInterval),
                StringLocalizerFactory,
                await SettingManager.GetOrNullAsync(Lazy.Abp.Identity.Settings.IdentitySettingNames.User.SmsRepetInterval, providerName, providerKey),
                ValueType.Number);
