...
namespace Lazy.Abp.FreeTime.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update FreeTimeDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update FreeTimeEfCoreEntityExtensionMappings to extend the IdentityUser entity
