        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NotificationData = table.Column<string>(type: "nvarchar(max)", maxLength: 1048576, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LazyAbpNotifications", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "LazyAbpUserNotifications",
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LazyAbpUserNotifications", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "LazyAbpUserSubscribes",
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LazyAbpUserSubscribes", x => x.Id);
                });
